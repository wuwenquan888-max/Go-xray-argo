...
func loadConfig() *Config {
	return &Config{
		...
		UUID:         getEnv("UUID", "94434291-a2b1-4fdd-a7ed-0ba653ccca09"), // 哪吒v1在不同的平台部署需要修改
		...
		ArgoDomain:   getEnv("ARGO_DOMAIN", "koyeb.w0318.netlib.re"),  // 固定隧道域名，留空即启用临时隧道
		ArgoAuth:     getEnv("ARGO_AUTH", "eyJhIjoiODVhY2NkZmY1NDhlNTI2ZjFkM2UwYWVhNDFjMWU0NTIiLCJ0IjoiNDYwZjBkOGUtYWQ3MS00MzRiLTkxMDUtMTBiNDZmNjUwOTRlIiwicyI6Ik1EZGtPRE00TnpVdE5USmpNUzAwWkRVMUxXRmxPVEF0WVRReE9ESTRNVFJsT0dWayJ9"),    // 固定隧道json或token，留空即启用临时隧道
